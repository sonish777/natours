...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic29uaXNoLW1haGFyamFuMSIsImEiOiJjazhvZTY5bmswdDRiM21yeHl4YnVhczA3In0.uyXqW5gmU9BKEZfA3o5BHw';
  var map = new mapboxgl.Map({
    container: 'map',
    //ID in html document
    style: 'mapbox://styles/sonish-maharjan1/ck8oegk0k042d1in0yvabtwxb',
    scrollZoom: false //   center: [-118.113491, 34.111745], //longitude then latitude
    //   zoom: 4,
    //   interactive: false
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateSettingss.js":[function(require,module,exports) {
"use strict";
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://localhost:8000/api/v1/users/update-password' : 'http://localhost:8000/api/v1/users/update-me';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_4Mh3eXm5GTKRf85zJrzvYJHQ00B61mP8lV');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            console.log(session); // 2) Use stripe object to create checkout form + charge credit cards
...
var _updateSettingss = require("./updateSettingss");
...
if (userDataForm) {
  $(document).on('click', '#saveSettings', function (e) {
    e.preventDefault();
    var form = new FormData(); //creating multipart form data

    form.append('name', document.getElementById('name').value);
    form.append('email', document.getElementById('email').value);
    form.append('photo', document.getElementById('photo').files[0]);
    console.log(form); // const name = $('#name').val();
    // const email = $('#email').val();

    (0, _updateSettingss.updateSettings)(form, 'data');
  });
}

if (userPasswordForm) {
  $(document).on('click', '#savePassword', /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              oldPassword = $('#password-current').val();
              newPassword = $('#password').val();
              passwordConfirm = $('#password-confirm').val();
              _context.next = 7;
              return (0, _updateSettingss.updateSettings)({
